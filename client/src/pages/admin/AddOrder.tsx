            ...
            <form onSubmit={handleSubmit}>
                <div className="mb-3">
                    ...
                    <select className="form-select" name="userId" value={formData.userId} onChange={handleChange}>
                        ...
                        {users.map(user => <option key={user._id || user.id} value={user._id || user.id}>{user.firstName}</option>)}
                            ...
                            <div className="row align-items-end">
                                <div className="col-md-5">
                                    ...
                                    >
                                        ...
                                        {products.map(prod => (
                                            <option key={prod._id || prod.id} value={prod._id || prod.id}>{prod.productName}</option>
                                        ))}
                                    </select>
                                ...
                                <div className="col-md-5">
                                    ...
                                    <div className="modern-qty-selector">
                                        ...
                                        <button
                                            ...
                                            disabled={(() => {
                                                const selectedProd = products.find(p => p._id === product.productId || p.id === product.productId);
                                                return selectedProd !== undefined && selectedProd.stock !== undefined && product.quantity >= selectedProd.stock;
                                            })()}
                                        >
                                            <i className="fa fa-plus"></i>
                                        </button>
                                    </div>
                                    {errors.products[index]?.quantity && <div className="error-message mt-2">{errors.products[index].quantity}</div>}
                                </div>
