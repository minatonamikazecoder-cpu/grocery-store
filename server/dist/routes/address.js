...
router.post("/", (0, validate_middleware_1.default)(address_validation_1.createAddressSchema), addressController.addAddress);
router.get("/:addressId", addressController.getAddressById);
router.get("/user/:userId", addressController.getAddressesByUserId);
router.put("/:addressId", (0, validate_middleware_1.default)(address_validation_1.updateAddressSchema), addressController.updateAddress);
