...
router.post("/", multer_middleware_1.default.single("bannerImage"), bannerController.addBanner);
router.put("/:bannerId", multer_middleware_1.default.single("bannerImage"), bannerController.updateBanner);
