...
export const getProductById = asyncHandler(async (req: Request, res: Response) => {
    ...
    const reviewStats = await AppDataSource.getRepository(Review)
    ...
    res.status(200).json(new ApiResponse(200, productData, "Product fetched successfully").toJSON());
});
...
export const createProduct = asyncHandler(async (req: Request, res: Response) => {
    ...
    const imageUrl = await uploadImage(localPath, "products");
    ...
    res.status(201).json(new ApiResponse(201, productData, "Product created successfully").toJSON());
});
...
export const getAllProducts = asyncHandler(async (req: Request, res: Response) => {
    ...
    if (products.length > 0) {
        ...
        const reviewMap: Record<string, { avgRating: string; totalReviews: number }> = {};
    ...
    res.status(200).json(
        new ApiResponse(200, enrichedProducts, "Products fetched successfully", {
            total,
            page,
...
export const getTrendingProducts = asyncHandler(async (req: Request, res: Response) => {
    ...
    const salesStats = await AppDataSource.getRepository(OrderItem)
    ...
    res.status(200).json(new ApiResponse(200, enriched, "Trending products fetched successfully").toJSON());
});
...
export const getLatestProducts = asyncHandler(async (req: Request, res: Response) => {
    ...
    res.status(200).json(new ApiResponse(200, enriched, "Latest products fetched successfully").toJSON());
});
...
export const updateProduct = asyncHandler(async (req: Request, res: Response) => {
    ...
    res.status(200).json(new ApiResponse(200, productData, "Product updated successfully").toJSON());
});
...
export const deleteProduct = asyncHandler(async (req: Request, res: Response) => {
    ...
    res.status(200).json(new ApiResponse(200, null, "Product marked as inactive successfully").toJSON());
});
...
export const getProductsByCategoryId = asyncHandler(async (req: Request, res: Response) => {
    ...
    res.status(200).json(
        new ApiResponse(200, enriched, "Products by category fetched successfully", {
            total,
            page,
            totalPages: Math.ceil(total / limit),
        }).toJSON()
...
export const searchProducts = asyncHandler(async (req: Request, res: Response) => {
    ...
    res.status(200).json(
        new ApiResponse(200, enrichedProducts, "Products searched successfully", {
            total,
            page,
            totalPages: Math.ceil(total / limit),
        }).toJSON()
